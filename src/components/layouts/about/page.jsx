...
export default function About() {
  return (
    <div className="my-10 mx-28 lg:mx-20">
      ...
      <p className="my-2 font-plus-jakarta-sans text-lg font-bold text-center">
        &ldquo;As a creative web artisan, I&apos;m passionate about merging imaginative
        ...
        web programming to bring visions to life.&rdquo;
      </p>
    </div>
  );
}
