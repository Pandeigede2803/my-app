  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      <div
        ...
        // }}
      >
        <h1 className=" text-2xl text-center flex justify-center  items-center align-middle my-auto">"Believe in yourself and all that you are. Know that there is something inside you that is greater than any obstacle."</h1>
      </div>
    </div>
  );
}
